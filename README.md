...
src/xio-agent.base.ts    Clase base AgentBase + roles LegalAgent, SalesAgent, MarketingAgent, EngineeringAgent, SupportAgent, FinanceAgent, ProductAgent, ResearchAgent
